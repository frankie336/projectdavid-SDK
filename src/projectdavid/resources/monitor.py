...
from ..types import monitor_register_run_params
...
class MonitorResource(SyncAPIResource):
    ...
    def register_run(
        ...
        *,
        ...
        return self._post(
            "/v1/monitor",
            body=maybe_transform({"run_id": run_id}, monitor_register_run_params.MonitorRegisterRunParams),
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    monitor_register_run_params.MonitorRegisterRunParams,
                ),
            ),
            cast_to=object,
        )
    ...
    async def register_run(
        ...
        *,
        ...
        return await self._post(
            "/v1/monitor",
            body=await async_maybe_transform({"run_id": run_id}, monitor_register_run_params.MonitorRegisterRunParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
...
class MonitorResourceWithRawResponse:
    def __init__(self, monitor: MonitorResource) -> None:
        ...
        self.register_run = to_raw_response_wrapper(
            monitor.register_run,
        )
...
class AsyncMonitorResourceWithRawResponse:
    def __init__(self, monitor: AsyncMonitorResource) -> None:
        ...
        self.register_run = async_to_raw_response_wrapper(
            monitor.register_run,
        )
...
class MonitorResourceWithStreamingResponse:
    def __init__(self, monitor: MonitorResource) -> None:
        ...
        self.register_run = to_streamed_response_wrapper(
            monitor.register_run,
        )
...
class AsyncMonitorResourceWithStreamingResponse:
    def __init__(self, monitor: AsyncMonitorResource) -> None:
        ...
        self.register_run = async_to_streamed_response_wrapper(
            monitor.register_run,
        )
