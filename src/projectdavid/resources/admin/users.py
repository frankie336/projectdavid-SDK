...
from ...types.admin import user_create_api_key_params
...
class UsersResource(SyncAPIResource):
    ...
    def create_api_key(
        ...
        *,
        ...
        """
        Allows an authenticated administrator to create a new API key for any specified
        user.
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                user_create_api_key_params.UserCreateAPIKeyParams,
            ),
